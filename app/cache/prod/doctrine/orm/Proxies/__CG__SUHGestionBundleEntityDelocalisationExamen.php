 ...
 */
class DelocalisationExamen extends \SUH\GestionBundle\Entity\DelocalisationExamen implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SUH\\GestionBundle\\Entity\\DelocalisationExamen' . "\0" . 'id', '' . "\0" . 'SUH\\GestionBundle\\Entity\\DelocalisationExamen' . "\0" . 'lieu', '' . "\0" . 'SUH\\GestionBundle\\Entity\\DelocalisationExamen' . "\0" . 'detail'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DelocalisationExamen $proxy) {
